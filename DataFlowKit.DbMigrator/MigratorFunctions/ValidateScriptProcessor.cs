...
{
    public static class ValidateScriptProcessor
    {
        public static int ValidateScript(ValidateScript opts)
        {
            CurrentCallInfo.ScriptName = RunningScriptType.ValidateScript;
            try
            {
                ...
                manager.ValidateScriptsAsync(scripts).GetAwaiter().GetResult();
